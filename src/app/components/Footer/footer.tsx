...
const Footer = () => {
  return (
    <>
      <footer className='footer bg-light-gray text-base-content p-10 grid lg:grid-cols-4 grid-cols-2'>
        <nav>
        ...
        <nav>
          ...
          <a className='link link-hover'>Manage Deliveries</a>
      ...
      <footer className='footer bg-light-gray text-base-content border-base-300 border-t px-10 py-4'>
        <aside className='grid-flow-col items-center'>
          ...
          <p>
            <span className='font-medium text-black'>SHOP.CO</span> Industries Ltd.
            <br />
